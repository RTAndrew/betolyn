...
const MarketConfiguration = forwardRef<ICreateCriterionScreenRef, ICreateCriterionScreen<IMarketConfigurationFormData>>(
      ...
      <View style={{ flex: 1, backgroundColor: '#61687E' }}>
        <View style={styles.formContainer}>
          ...
          <View style={{ marginBottom: 16 }}>
            ...
            <ThemedText style={{ color: '#C7D1E7' }} type="default">If this criterion is intended to be used as a main criterion, create short names (e.g. W, L, D, Home, Away) for higher visibility.</ThemedText>
          </View>
