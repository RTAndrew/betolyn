...
from apps.espn.models import AllowlistedCompetition, Athlete, Competitor, Event, League, Sport, Team, Venue


@admin.register(AllowlistedCompetition)
class AllowlistedCompetitionAdmin(admin.ModelAdmin):
    """Product allowlist for Celery horizon + team jobs."""
    ...
    list_filter = ["enabled", "sport_slug", "team_source"]
    search_fields = ["display_name", "league_slug", "sport_slug"]
