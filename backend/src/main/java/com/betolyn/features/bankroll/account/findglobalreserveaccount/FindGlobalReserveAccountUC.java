package com.betolyn.features.bankroll.account.findglobalreserveaccount;
...
public class FindGlobalReserveAccountUC implements IUseCase<Void, AccountEntity> {

    private final AccountRepository accountRepository;

    @Override
    public AccountEntity execute(Void param) {
        return accountRepository.findByOwnerId(BankrollConstants.GLOBAL_RESERVE_ACCOUNT)
